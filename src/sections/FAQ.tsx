        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="font-manrope font-light text-charcoal-300 mt-8 max-w-sm leading-relaxed">
              Still have questions? We're here to help you prepare for your
              perfect visit.
            </p>
          ...
          >
            {FAQ_KEYS.map((key) => (
              ...
              >
                ...
                >
                  <span
                    className={`font-cormorant font-light text-xl transition-colors duration-300 pr-6 ${
                      open === key
                        ? "text-champagne-300"
                        : "text-white group-hover:text-champagne-200"
                    }`}
                  >
                    {t(`faq.items.${key}.q`)}
                  </span>
                  <div
                    className={`w-8 h-8 border flex items-center justify-center flex-shrink-0 transition-all duration-300 ${
                      open === key
                        ...
                        : "border-charcoal-600 text-charcoal-400 group-hover:border-champagne-600"
                    }`}
                  >
