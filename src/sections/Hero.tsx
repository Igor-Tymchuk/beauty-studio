    ...
    <section id="hero" ref={ref} className="relative min-h-dvh overflow-hidden">
      ...
      >
        ...
        <div className="flex-none flex items-end justify-between pb-8 md:pb-10">
          ...
          >
            {[
              ...
              <div key={stat.num} className="flex flex-col">
                <span className="font-cormorant text-2xl md:text-3xl text-champagne-300">
                  {stat.num}
                </span>
          ...
          >
            <span className="hidden sm:block font-manrope text-xs tracking-widest uppercase text-ivory-400">
              {t("hero.scroll")}
            </span>
